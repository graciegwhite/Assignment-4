...
Sample means of measured carapce lengths ± 1 standard deviation (mm) of lobsters in 2017. Count represents the number of lobsters measured at each site. Like letters indicate means that do not differ significantly by one-way ANOVA (F(4,1663) = 3.424, p = 0.0085, $\alpha$ = 0.05) with Tukey's HSD ($\alpha$ = 0.05). 
